...
License texts and attributions are bundled in the APK and can be read offline
in **Licenses and attribution**.
...
License: MIT — [full text](licenses/Shizuku-API-MIT.txt).
...
Main license: [Apache 2.0](licenses/Apache-2.0.txt).
Source: https://github.com/JetBrains/kotlin/tree/v2.2.21/libraries/stdlib
...
- GWT-derived collections: Copyright 2007 Google Inc. — [Kotlin-gwt_license.txt](licenses/Kotlin-gwt_license.txt).
- Guava-derived unsigned arithmetic: Copyright 2011 The Guava Authors — [Kotlin-guava_license.txt](licenses/Kotlin-guava_license.txt).
- Boost-derived math functions: Copyright Eric Ford & Hubert Holin 2001. — [Kotlin-boost_LICENSE.txt](licenses/Kotlin-boost_LICENSE.txt).
- ThreeTenBP-derived time handling: Copyright (c) 2007-present, Stephen Colebourne & Michael Nascimento Santos — [Kotlin-threetenbp_license.txt](licenses/Kotlin-threetenbp_license.txt).

Reference: https://github.com/JetBrains/kotlin/blob/v2.2.21/license/README.md
...
Version sources: https://dl.google.com/dl/android/maven2/androidx/annotation/annotation/1.3.0/annotation-1.3.0-sources.jar
...
License: [Apache 2.0](licenses/Apache-2.0.txt).
Version sources: https://repo1.maven.org/maven2/org/jetbrains/annotations/13.0/annotations-13.0-sources.jar
...
Project: https://github.com/gradle/gradle/tree/v8.13.0
