...
Le OnePlus a ensuite été connecté par ADB sans fil. Pendant l’essai, le répartiteur Android confirme : Guild Wars focalisé, mouvements avec l’identifiant -1, boutons physiques avec l’identifiant 15, files sans blocage et canal du jeu réactif. Les fenêtres Razer présentes dans l’état système n’étaient pas visibles et ne détenaient pas le focus.

Un prototype a obtenu EVIOCGRAB sur le périphérique physique de la Kishi avec l’identité shell, sans root, puis retransmis son flux via UHID. Pendant l’essai de 45 secondes, Android a attribué le même identifiant de manette enregistrée aux boutons et mouvements retransmis. L’utilisateur a confirmé : **« Tout fonctionne »**. Le prototype a compté 4 126 événements bruts et 1 613 rapports HID avant de libérer automatiquement la manette. Cette réussite motive le remplacement du transport dans la 0.1.2 ; voir le [compte rendu de cette version](VALIDATION.md) pour la validation de l’APK intégré.
